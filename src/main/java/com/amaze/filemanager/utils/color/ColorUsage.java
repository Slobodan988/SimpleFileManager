...
public enum ColorUsage {
    PRIMARY("skin", R.color.primary_green),
    PRIMARY_TWO("skin_two", R.color.primary_green),
    ACCENT("accent_skin", R.color.accent_blue),
    ICON_SKIN("icon_skin", R.color.primary_green),
    CURRENT_TAB("current_tab", R.color.primary_green);
