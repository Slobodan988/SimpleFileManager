...
public class AboutActivity extends BasicActivity implements View.OnClickListener {
    ...
    private static final String URL_REPO_CHANGELOG = "https://play.google.com/store/apps/dev?id=5778053025552629219";
...
//        mXda.setOnClickListener(this);
        ...
        Palette.from(bitmap).generate(new Palette.PaletteAsyncListener() {
            ...
            public void onGenerated(Palette palette) {
                ...
                int mutedColor = palette.getMutedColor(getResources().getColor(R.color.primary_green));
                int darkMutedColor = palette.getDarkMutedColor(getResources().getColor(R.color.primary_green));
